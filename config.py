...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7404600334:AAGpQv2DJb-s7yjXsgmH9_0pBOVFw7O1HXE")
...
NEW_REQ_MODE = os.environ.get("NEW_REQ_MODE", "-1001457313028").lower() == "True"  # Set "True" For accept new requests
...
IS_FSUB = os.environ.get("IS_FSUB", "-1001457313028").lower() == "True"  # Set "True" For Enable Force Subscribe
